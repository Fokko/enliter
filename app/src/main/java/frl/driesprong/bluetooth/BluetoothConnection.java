...
import frl.driesprong.bluetooth.operations.GattDescriptorReadOperation;
import frl.driesprong.bluetooth.operations.GattDiscoverServices;
import frl.driesprong.bluetooth.operations.GattInitializeBluetooth;
import frl.driesprong.bluetooth.operations.GattOperation;
import frl.driesprong.bluetooth.operations.GattSetNotificationOperation;
...
public class BluetoothConnection {
    ...
    protected BluetoothConnection() {
        Log.w(TAG, "Initializing bluetooth");
    ...
    public void disconnect() {
        ...
        this.queue(new GattInitializeBluetooth());
    }

    public final synchronized void queue(GattOperation gattOperation) {
        Log.w(TAG, "Queued: " + gattOperation);
                            ...
                            result.getDevice().connectGatt(context, false, new BluetoothGattCallback() {
                                ...
                                public void onCharacteristicRead(final BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic, int status) {
                                    ...
                                    if (characteristic.getUuid().toString().equals(GattAttributes.GLUCOSELINK_RX_PACKET_UUID)) {
                                        ...
                                        final MedtronicReading pack = MedtronicDecoder.DeterminePackage(data);
